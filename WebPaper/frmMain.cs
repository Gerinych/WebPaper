...
namespace WebPaper {
    public partial class frmMain: Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            setInterval(Settings.Default.interval);
            comboBox1.SelectedIndex = Settings.Default.interval;
        }
        ...
        //change wallpaper when the timer ticks
        ...
        private void frmClose(object sender, FormClosingEventArgs e) {
            if (e.CloseReason != CloseReason.ApplicationExitCall) {
                e.Cancel = true;
                this.Hide();
                stIcon.BalloonTipTitle = "WebPaper in background";
                stIcon.BalloonTipText = "Double click icon to open settings";
                stIcon.BalloonTipClicked += delegate { this.Show(); };

                stIcon.ShowBalloonTip(3000);
            }
        }
    ...
    class Location {
        ...
        public Image getImage() {
            if (dataUri != null) {
                dataUri = dataUri.Remove(0, 23);
                byte[] imageBytes = Convert.FromBase64String(dataUri);
        ...
        public class Geocode {
            ...
            public override string ToString() {
                string ret = "";
                if (administrative_area_level_2 != null) ret += administrative_area_level_2 + ", ";
                if (administrative_area_level_1 != null) ret += administrative_area_level_1 + ", ";
                ret += country;
                return ret;
            }
        }
